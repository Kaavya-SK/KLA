...
with open("Z:\Student Handout\level0\level_zero.json.json", 'r') as file:
    data = json.load(file)
...
jsonString = json.dumps(output_path)
jsonFile = open("Z:\Student Handout\level0\level0_output.json", "w")
